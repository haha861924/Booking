...
var devtoolsImpl = (fn, devtoolsOptions = {}) => (set, get, api) => {
  ...
  try {
    extensionConnector = (enabled != null ? enabled : (import_meta.env && import_meta.env.MODE) !== "production") && window.__REDUX_DEVTOOLS_EXTENSION__;
  } catch {
  }
  if (!extensionConnector) {
    if ((import_meta.env && import_meta.env.MODE) !== "production" && enabled) {
      console.warn(
  ...
  if (api.dispatchFromDevtools && typeof api.dispatch === "function") {
    ...
    api.dispatch = (...a) => {
      if ((import_meta.env && import_meta.env.MODE) !== "production" && a[0].type === "__setState" && !didWarnAboutReservedActionType) {
        console.warn(
